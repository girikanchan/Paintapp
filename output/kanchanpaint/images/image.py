...
class FirstPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        load = Image.open("C:\\Users\\LENOVO\\Desktop\\images\\backgroud.jpg")
        ...
        def verify():
            try:
                with open("C:\\Users\\LENOVO\\Desktop\\login.txt", "r") as f:
                    info = f.readlines()
                    i  = 0
                    for e in info:
                        u, p =e.split(",")
        ...
        def register():
            ...
            def check():
                if t1.get()!="" or t2.get()!="" or t3.get()!="":
                    if t2.get()==t3.get():
                        with open("C:\\Users\\LENOVO\\Desktop\\login.txt", "a") as f:
...
class SecondPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        load = Image.open("C:\\Users\\LENOVO\\Desktop\\images\\login.jpg")
        photo = ImageTk.PhotoImage(load)
        label = tk.Label(self, image=photo)
        label.image=photo
        label.place(x=0,y=0)
        ...
        Button = tk.Button(self, text="Done", font=("Arial", 15), command=lambda: controller.show_frame(ThirdPage))
        Button.place(x=650, y=450)
        
        Button = tk.Button(self, text="Let's Chat", font=("Arial", 15), command=lambda: controller.show_frame(FirstPage))
