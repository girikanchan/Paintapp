...
class Sketch:
        ...
        if notation == 1:
            ...
            if notation == 18:
               take = messagebox.askyesno("Clear Conformation","Are you sure to Clear?")
                ...
                self.window.title("Art Board" + "-----" + "New Window")
            if take is True:
    ...
    def controller(self):
        self.controller_set = LabelFrame(self.window,text="Controller",bg="#F7F2F2",fg="blue",width=250,height=684,relief=RAISED,bd=10, font=("Arial", 10, "bold"))
        ...
        self.notation_box = Listbox(self.controller_set, width=5, height=11, font=("Arial", 10, "bold"), fg="yellow",
                                    bg="#EABE18", relief=SUNKEN, bd=5)
        self.notation_box.place(x=180, y=305)

        self.segment_1 = Label(self.controller_set,text="Shapes and lines",bg="#DEF5E1",fg="brown",font=("Arial", 12, "bold"),relief=GROOVE,bd=1,padx=10,pady=1)
        self.segment_1.place(x=40,y=3)

        self.line_img = ImageTk.PhotoImage(Image.open("Pictures/line.jpg").resize((20, 20), Image.Resampling.LANCZOS))
        ...
        self.das_img = ImageTk.PhotoImage(Image.open("Pictures/dashed_line.png").resize((20, 20), Image.Resampling.LANCZOS))
        ...
        self.rectangle_img = ImageTk.PhotoImage(Image.open("Pictures/rectangle.jpg").resize((20, 20), Image.Resampling.LANCZOS))
        ...
        self.parallelogram_img = ImageTk.PhotoImage(Image.open("Pictures/parallelogram.png").resize((20, 20), Image.Resampling.LANCZOS))
        ...
        self.traingle_img = ImageTk.PhotoImage(Image.open("Pictures/traingle.jpg").resize((20, 20), Image.Resampling.LANCZOS))
        ...
        self.pentagon_img = ImageTk.PhotoImage(Image.open("Pictures/pentagon.png").resize((20, 20), Image.Resampling.LANCZOS))
        ...
        self.hexagon_img = ImageTk.PhotoImage(Image.open("Pictures/hexagon.png").resize((20, 20), Image.Resampling.LANCZOS))
        ...
        self.arrow_img = ImageTk.PhotoImage(Image.open("Pictures/arrow.png").resize((20, 20), Image.Resampling.LANCZOS))
        ...
        self.circle_img = ImageTk.PhotoImage(Image.open("Pictures/circle.png").resize((20, 20), Image.Resampling.LANCZOS))
        ...
        self.right_angled_traingle_img = ImageTk.PhotoImage(Image.open("Pictures/right_angled_traingle.png").resize((20, 20), Image.Resampling.LANCZOS))
        ...
        self.rounded_rec_img = ImageTk.PhotoImage(Image.open("Pictures/rounded_rectangle.png").resize((20, 20), Image.Resampling.LANCZOS))
        ...
        self.arrow_left_img = ImageTk.PhotoImage(Image.open("Pictures/left_arrow.png").resize((20, 20), Image.Resampling.LANCZOS))
        ...
        self.segment_2 = Label(self.controller_set, text="Tools Collection", bg="#DEF5E1", fg="brown",
                               font=("Arial", 12, "bold"), relief=GROOVE, bd=1, padx=10, pady=1)
        self.segment_2.place(x=40, y=210)

        self.pencil_img = ImageTk.PhotoImage(Image.open("Pictures/pencil.png").resize((17, 17), Image.Resampling.LANCZOS))
        ...
        self.eraser_img = ImageTk.PhotoImage(Image.open("Pictures/eraser.png").resize((17, 17), Image.Resampling.LANCZOS))
        ...
        self.text_img = ImageTk.PhotoImage(Image.open("Pictures/text_pic.png").resize((17, 17), Image.Resampling.LANCZOS))
        ...
        self.selection_img = ImageTk.PhotoImage(Image.open("Pictures/selection_box.png").resize((17, 17), Image.Resampling.LANCZOS))
        ...
        self.color_box_img = ImageTk.PhotoImage(Image.open("Pictures/color_conatiner.png").resize((17, 17), Image.Resampling.LANCZOS))
    ...
    def make_menu(self):
        ...
        for i in range(17):
            ...
            self.menu_img_container[i] = ImageTk.PhotoImage(
                Image.open("Pictures/" + menu_img[i]).resize((30, 30), Image.Resampling.LANCZOS))

        self.file_menu = Menu(self.my_menu,tearoff=False)
        self.my_menu.add_cascade(label="File",menu=self.file_menu)
        self.file_menu.add_command(label="New",accelerator="(Ctrl+N)",command=lambda: self.control(19),image=self.menu_img_container[0],compound=LEFT,background="white",foreground="#1929F4",font=("Arial",10,"bold"),activebackground="yellow",activeforeground="green")
        self.file_menu.add_command(label="Open",accelerator="(Ctrl+O)",command=lambda: self.open_file(False),image=self.menu_img_container[1],compound=LEFT,background="white",foreground="#1929F4",font=("Arial",10,"bold"),activebackground="yellow",activeforeground="green")
        self.file_menu.add_command(label="Save",accelerator="(Ctrl+S)",command=lambda: self.save_file(False),state=DISABLED,image=self.menu_img_container[2],compound=LEFT,background="white",foreground="#1929F4",font=("Arial",10,"bold"),activebackground="yellow",activeforeground="green")
        self.file_menu.add_command(label="Exit",command=lambda: self.control(20),image=self.menu_img_container[3],compound=LEFT,background="white",foreground="#1929F4",font=("Arial",10,"bold"),activebackground="yellow",activeforeground="green")
        ...
        self.edit_menu.add_command(label="Undo", command=lambda: self.undo(False),accelerator="(Ctrl+Z)",state=DISABLED,image=self.menu_img_container[4],compound=LEFT,background="white",foreground="#1929F4",font=("Arial",10,"bold"),activebackground="yellow",activeforeground="green")
        self.edit_menu.add_command(label="Clear", command=lambda: self.control(18),state=DISABLED,image=self.menu_img_container[5],compound=LEFT,background="white",foreground="#1929F4",font=("Arial",10,"bold"),activebackground="yellow",activeforeground="green")
        self.edit_menu.add_command(label="Cut", command=lambda: self.cut(False), accelerator="(Ctrl+X)",state=DISABLED,image=self.menu_img_container[6],compound=LEFT,background="white",foreground="#1929F4",font=("Arial",10,"bold"),activebackground="yellow",activeforeground="green")
        self.edit_menu.add_command(label="Copy", command=lambda: self.copy(0),accelerator="(Ctrl+C)",state=DISABLED,image=self.menu_img_container[7],compound=LEFT,background="white",foreground="#1929F4",font=("Arial",10,"bold"),activebackground="yellow",activeforeground="green")
        self.edit_menu.add_command(label="Paste", command=lambda: self.paste(False),accelerator="(Ctrl+V)",state=DISABLED,image=self.menu_img_container[8],compound=LEFT,background="white",foreground="#1929F4",font=("Arial",10,"bold"),activebackground="yellow",activeforeground="green")
        self.edit_menu.add_command(label="Screen Shot", command=lambda: self.screen_shot_taking(False),accelerator="(Ctrl+Alt+C)",state=DISABLED,image=self.menu_img_container[9],compound=LEFT,background="white",foreground="#1929F4",font=("Arial",10,"bold"),activebackground="yellow",activeforeground="green")
        ...
        self.color_menu.add_command(label="Change Background Color",command=lambda: self.control(21),image=self.menu_img_container[10],compound=LEFT,background="white",foreground="#1929F4",font=("Arial",10,"bold"),activebackground="yellow",activeforeground="green")
        self.color_menu.add_command(label="Change Permanent Fill and Outline Color", command=self.set_permanent_choose_color,image=self.menu_img_container[11],compound=LEFT,background="white",foreground="#1929F4",font=("Arial",10,"bold"),activebackground="yellow",activeforeground="green")

        self.option_menu = Menu(self.my_menu, tearoff=False)
        self.my_menu.add_cascade(label="Option", menu=self.option_menu)
        self.option_menu.add_command(label="Zoom in",accelerator="(Ctrl+Scroll up)",command=lambda: self.zoom_controller(1),image=self.menu_img_container[12],compound=LEFT,background="white",foreground="#1929F4",font=("Arial",10,"bold"),activebackground="yellow",activeforeground="green")
        self.option_menu.add_command(label="Zoom out", accelerator="(Ctrl+Scroll down)",command=lambda: self.zoom_controller(0),image=self.menu_img_container[13],compound=LEFT,background="white",foreground="#1929F4",font=("Arial",10,"bold"),activebackground="yellow",activeforeground="green")
        self.option_menu.add_separator(background="green")
        self.option_menu.add_command(label="Color Pen Width Increase", accelerator="(Shift+Scroll up)", command=lambda: self.color_box_width_controller(1),image=self.menu_img_container[14],compound=LEFT,background="white",foreground="#1929F4",font=("Arial",10,"bold"),activebackground="yellow",activeforeground="green")
        self.option_menu.add_command(label="Color Pen Width Decrease", accelerator="(Shift+Scroll down)", command=lambda: self.color_box_width_controller(0),image=self.menu_img_container[14],compound=LEFT,background="white",foreground="#1929F4",font=("Arial",10,"bold"),activebackground="yellow",activeforeground="green")
        self.option_menu.add_separator(background="green")
        self.option_menu.add_command(label="Movement", state=DISABLED, command=lambda: self.control(22),image=self.menu_img_container[15],compound=LEFT,background="white",foreground="#1929F4",font=("Arial",10,"bold"),activebackground="yellow",activeforeground="green")

        self.help_menu = Menu(self.my_menu, tearoff=False)
        self.my_menu.add_cascade(label="Help", menu=self.help_menu)
        self.help_menu.add_command(label="About",command=self.about,image=self.menu_img_container[16],compound=LEFT,background="white",foreground="#1929F4",font=("Arial",10,"bold"),activebackground="yellow",activeforeground="green")
        self.help_menu.add_command(label="Tips", command=self.tips, image=self.menu_img_container[16], compound=LEFT, background="white", foreground="#1929F4", font=("Arial", 10, "bold"), activebackground="yellow", activeforeground="green")
    ...
    def save_file(self,e):#for save a file
        ...
        if file:
            ...
            self.window.title("Art Board" + "-----" + file + ".png")
    ...
    def width_controller(self):#Width Controller box
        self.make_width_frame = Frame(self.controller_set,relief=GROOVE,bd=5,width=10,height=10,bg="#CFFCF1")
        ...
        self.shape_outline_width_label = Label(self.make_width_frame,text="Border Outline",font=("Arial",12,"bold"),bg="#F2FEFB",fg="#0B0BF2",padx=20)
        ...
        self.eraser_width_label = Label(self.make_width_frame, text="Eraser size", font=("Arial", 12, "bold"),
                                               bg="#F2FEFB", fg="#0B0BF2", padx=20)
    ...
    def color_set(self):#Color set from colorbox
        ...
        for i in range(15):
            ...
            self.color_container[i] = ImageTk.PhotoImage(Image.open("Pictures/" + color_storage[i]).resize((15, 15), Image.Resampling.LANCZOS))
    ...
    def set_permanent_choose_color(self):#Set permanent color: border and background
        ...
        self.choosing_color = ImageTk.PhotoImage(Image.open("Pictures/choose_color.png").resize((15, 15), Image.Resampling.LANCZOS))
    ...
    def about(self):#About under Help menu
        ...
        self.about_img[0] = ImageTk.PhotoImage(Image.open("Pictures/Shapes_and_lines_box.png").resize((200,160),Image.Resampling.LANCZOS))
        self.about_img[1] = ImageTk.PhotoImage(Image.open("Pictures/Tools_collection.png").resize((200, 100), Image.Resampling.LANCZOS))
        self.about_img[2] = ImageTk.PhotoImage(Image.open("Pictures/width_controller.png").resize((140, 160), Image.Resampling.LANCZOS))
        self.about_img[3] = ImageTk.PhotoImage(Image.open("Pictures/Notation_box.png").resize((30, 150), Image.Resampling.LANCZOS))
        self.about_img[4] = ImageTk.PhotoImage(Image.open("Pictures/Color_segment.png").resize((200, 140), Image.Resampling.LANCZOS))

        heading = Label(top, text="All about Tools", font=("Arial", 30, "bold", "italic"),fg="brown", bg="#F5F4B7")
        ...
        des_label_all[0] = Label(top,text="This box contains all shapes and lines",font=("Arial",30,"bold"),fg="#1848EA",bg="#F5F4B7")
        ...
        des_label_all[1] = Label(top, text="This box contains all essential tools", font=("Arial", 30, "bold"),fg="#1848EA", bg="#F5F4B7")
        ...
        des_label_all[2] = Label(top, text="Width controller box", font=("Arial", 30, "bold"),fg="#1848EA", bg="#F5F4B7")
        ...
        des_label_all[3] = Label(top, text="Line and Shape Indexing Box", font=("Arial", 30, "bold"), fg="#1848EA",bg="#F5F4B7")
        ...
        des_label_all[4] = Label(top, text="Coloring Box", font=("Arial", 30, "bold"), fg="#1848EA",bg="#F5F4B7")
    ...
    def tips(self):#Tips under Help menu
        ...
        top.wm_iconbitmap("Icons/main_logo.ico")
        top.config(bg="#F0F0EC")
        self.about_img.clear()
        self.about_img.append(0)

        heading = Label(top, text="Tips of Art Board", font=("Arial", 30, "bold", "italic"), fg="brown",
                        bg="#F0F0EC")
        heading.place(x=500, y=10)

        self.about_img[0] = ImageTk.PhotoImage(Image.open("Pictures/line.jpg").resize((20, 20), Image.Resampling.LANCZOS))

        tip_label_img = Label(top, text="Shift + ", font=("Arial", 20, "bold"), fg="#1848EA", bg="#F0F0EC")
        tip_label_img.place(x=20, y=80)
        tip_label = Label(top, image=self.about_img[0], relief=RAISED, bd=3)
        tip_label.place(x=120, y=85)
        tip_label_img = Label(top, text="====>   Make Straight line: Vertical and Horizontal", font=("Arial", 15, "bold"), fg="#1848EA", bg="#F0F0EC")
        tip_label_img.place(x=160, y=85)

        f_lb = Label(top, text="F ====>  For Change Background Color of the Selected Shape or Line", font=("Arial", 15, "bold"), fg="#1848EA", bg="#F0F0EC")
        f_lb.place(x=120, y=150)

        l_lb = Label(top, text="O ====>  For Change Outline Color of the Selected Sbape", font=("Arial", 15, "bold"), fg="#1848EA", bg="#F0F0EC")
        l_lb.place(x=120, y=225)

        p_lb = Label(top, text="P ====>  For Change Background and Outline Color permanently of the upcoming shapes and lines",font=("Arial", 15, "bold"), fg="#1848EA", bg="#F0F0EC")
        p_lb.place(x=120, y=290)

        del_lb = Label(top, text="Select a region + Delete button--->Delete the Segment ",font=("Arial", 15, "bold"), fg="#1848EA", bg="#F0F0EC")
